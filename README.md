...
## Example
You can find an example in the main branch which models Fraud data that can be find on [kaggle]([https://pages.github.com/](https://www.kaggle.com/datasets/volodymyrgavrysh/fraud-detection-bank-dataset-20k-records-binary)). In particular you can find a possible data prepartion before running Logitstep.
